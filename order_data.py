...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_0.setGeometry(QtCore.QRect(20, 330, 300, 30))
        self.label_0.setObjectName("label")

        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(320, 330, 300, 30))
        ...
        self.label.setGeometry(QtCore.QRect(20, 380, 150, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Заказанные товары"))
        ...
        self.label_0.setText(_translate("MainWindow", "Добавление товара в заказ"))
        self.label_0.setFont(QFont('Arial', 14))

        self.label_8.setText(_translate("MainWindow", "Удаление товара из заказа"))
        self.label_8.setFont(QFont('Arial', 14))

        self.label.setText(_translate("MainWindow", "Код карточки заказа"))
